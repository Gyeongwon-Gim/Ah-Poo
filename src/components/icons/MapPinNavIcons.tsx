...
interface MapPinNavIconProps {
  className?: string;
}

/** 비활성 — 테두리만 (lucide MapPin) */
export function MapPinNavInactive({ className }: MapPinNavIconProps) {
  return (
    <MapPin
      className={className}
      size={20}
...
/** 활성 — 같은 핀 실루엣, 안쪽 채움 */
export function MapPinNavActive({ className }: MapPinNavIconProps) {
  return (
    <svg
      className={className}
      width="20"
